...
<div class="page-shell">
  ...
  <div class="form-card">
    ...
    <div class="form-header">
      <h1>Add New Degree Program</h1>
      <p>Create a new degree program for your institution</p>
    </div>
    ...
    <div class="form-container">
      <form action="/degrees" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" id="degree_title" class="form-control @error('degree_title') is-invalid @enderror" name="degree_title" placeholder="e.g., Bachelor of Science in Computer Science" value="{{ old('degree_title') }}" required />
