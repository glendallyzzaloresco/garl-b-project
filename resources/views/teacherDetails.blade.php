...
.back-link:hover { background: var(--orange); color: #fff; border-color: var(--orange); }
...
.field-value.accent { color: var(--orange); font-size: 13px; }
.field-value.role-val {
  ...
  <div class="profile-card">
    ...
    <div class="card-header">
      ...
      <div class="header-text">
        <div class="profile-badge">Teacher Profile</div>
    ...
    <div class="card-body">
      ...
      <div class="section-block">
        <div class="section-title">
          <i class="bi bi-person" style="color:var(--orange)"></i>
          Personal Information
        </div>
        <div class="fields-row">
          <div class="field-item f1">
            <div class="field-label">First Name</div>
            <div class="field-value">{{ $teacher->fname ?? 'N/A' }}</div>
          </div>
          <div class="field-item f2">
            <div class="field-label">Middle Name</div>
            <div class="field-value">{{ $teacher->mname ?? 'N/A' }}</div>
          </div>
          <div class="field-item f3">
            <div class="field-label">Last Name</div>
            <div class="field-value">{{ $teacher->lname ?? 'N/A' }}</div>
          </div>
        </div>
      </div>
      ...
      <div class="section-block">
        <div class="section-title">
          <i class="bi bi-envelope" style="color:var(--orange)"></i>
          Contact Information
        </div>
        <div class="fields-row">
          <div class="field-item f4">
            <div class="field-label">Email Address</div>
            <div class="field-value accent">{{ $teacher->email }}</div>
          </div>
          <div class="field-item f5">
            <div class="field-label">Contact Number</div>
            <div class="field-value">{{ $teacher->phone ?? 'Not Provided' }}</div>
          </div>
        </div>
      </div>
      ...
      <div class="section-block">
        ...
        <div class="fields-row">
          <div class="field-item f1">
            ...
            <div class="field-value">{{ $teacher->username }}</div>
          </div>
          <div class="field-item f2">
            <div class="field-label">Role</div>
            <div class="field-value role-val">
              {{ ucfirst($teacher->role) }}
            </div>
          </div>
        </div>
