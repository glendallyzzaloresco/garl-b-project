...
<div class="dashboard-container">
  ...
  <div class="dashboard-grid">
    ...
    <!-- <div class="dashboard-card">
      ...
      <p class="card-value" style="font-size: 1.3rem; color: var(--green);">
  ...
  <div class="profile-section">
    ...
    <div class="avatar-row">
      ...
      <form class="avatar-form" action="{{ route('teacher.avatar.upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
